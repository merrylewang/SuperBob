...
public class PlatformView extends SurfaceView implements Runnable {
    ...
    PlatformView(Context context, int screenWidth, int screenHeight) {
        ...
        songs.add(R.raw.awesomenauts);
        songs.add(R.raw.mega);
        songs.add(R.raw.mario);
        songs.add(R.raw.dk);
        songs.add(R.raw.kart);
        songs.add(R.raw.diddy);

        //start
        mediaPlayer = MediaPlayer.create(context,R.raw.mega);
        mediaPlayer.start();
        ...
        //loadLevel("LevelCave2", 8f, 16f);
        //loadLevel("LevelCity2", 118f, 18f);
        //loadLevel("LevelForest2", 10f, 60f);
        //loadLevel("LevelMountain2", 50f, 17f);
    ...
    private void update() {
        if(!mediaPlayer.isPlaying()){
            ...
            mediaPlayer = MediaPlayer.create(context,songs.get(i));
            mediaPlayer.start();
        }
